$(document).ready(function(){
    ...
    $('button').on('click', function() {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animal + "&api_key=by29g3suHV30nx956bIxLaOt86SOURvt&limit=10";
    ...
    var animals = [''];
        ...
        $('#theButton').on('click', function(){
            ...
            queryURL = "https://api.giphy.com/v1/gifs/search?q=" + animalButton + "&api_key=by29g3suHV30nx956bIxLaOt86SOURvt";
